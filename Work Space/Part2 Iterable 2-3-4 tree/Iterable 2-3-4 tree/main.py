...
def main():
    ...
    # Build the actual list of integers by iterating through the tree.
    # Keep track of the number of iterations and if more iterations occur than expected, then stop.
    actual = []
    iteration_count = 0
